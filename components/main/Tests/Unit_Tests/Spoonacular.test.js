...
describe('Spoonacular.js', () => {
    test('STC1. Spoonacular.js given one ingredient, one intolerance and a diet, creates a complex recipe search API query as expected.', () => {
        ...
        if (apiKeys.includes(apiKey)){
            toBeString = "https://api.spoonacular.com/recipes/complexSearch?apiKey=" + apiKey + "&includeIngredients=" + ingredients + "&number=10&sort=min-missing-ingredients&fillIngredients=true&instructionsRequired=true&intolerances=" + intolerances + "&diet=" + diet + "&ignorePantry=false"
        }
