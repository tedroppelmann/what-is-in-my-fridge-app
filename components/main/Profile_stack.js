    ...
    return (
        <NavigationContainer independent={true}>
          ...
          <Stack3.Navigator initialRouteName='Profile'>
            ...
            <Stack3.Screen name="Dietary Restrictions" component={DietRestrictionsScreen} />
            <Stack3.Screen name="Ingredients Exclusion" component={IngredientsExlusionScreen}/>
            <Stack3.Screen name="Intolerance Restrictions" component={IntoleranceRestrictionsScreen}/>
          </Stack3.Navigator>
        </NavigationContainer>
    )
}